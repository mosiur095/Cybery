                  ...
                  <img
                    ...
                    src={`${
                      !(router.pathname === '/trials')
                        ? hasScrolled
                          ? '/images/cybery-logo.png'
                          : '/images/cybery-logo-white.png'
                        : '/images/cybery-logo.png'
                    }`}
                    alt='Logo'
                    title='Cybery Limited'
                  />
                </Link>
              </div>
            </div>
              ...
              <div className='header-right'>
                <nav id='menu' className='menu menu-primary'>
                  <ul>
                    ...
                    <li className={checkPath('/services')}>
  ...
  .header .header-right .menu-primary > ul > li > a {
    ...
    color: ${(props) =>
      !(props.router === '/trials')
        ...
        : 'var(--tertiary2)'};
    /* color: ${(props) =>
      props.hasScrolled ? 'var(--tertiary2)' : '#ffffff'}; */
    display: inline-block;
    padding-top: 40px;
    padding-bottom: 40px;
    padding-left: 20px;
