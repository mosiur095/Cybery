            ...
            <div className="row">
                <div className="col-sm-12">
                    <div className="text-center mb-7">
                        ...
                        <p className="ourfilm-description">We are a team of creative minds with years of experience in the Graphics design industry. <br/> Photo editing for the Automotive and Real-estate industry is our main thing followed by 3D and Video editing.</p>
                    </div>
                </div>
            </div>
            <Carousel 
        ...
        onMouseOut={() => setHover(false)}>
            <div className="team-item">
                ...
                <div className="info">
                    ...
                    <div className="tagline"><b>{occupation}</b></div>
                </div>
            </div>
        </TeamMember>
    )
