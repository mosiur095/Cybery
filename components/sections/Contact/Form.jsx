...
const ContactLinksData = [
    {
        name: 'Facebook',
        href:'https://www.facebook.com/cybery.global',
        className:'fa fa-facebook'
    },
    {
        name: 'Pinterest',
        href:'https://www.pinterest.com/cyberyglobal1/',
        className:'fa fa-pinterest'
    },
    {
        name: 'Linkedin',
        href:'https://www.linkedin.com/company/cybery/',
        className:'fa fa-linkedin'
    },
    {
        name: 'Instagram',
        href:'https://www.instagram.com/cybery.ai/',
...
const ContactInformationData = [
    {
        title: 'Address',
        info: 'Mahfuza Tower - 7th floor <br />36/37 Probal Housing, Ring Road <br> Dhaka -1207',
    },
    {
        title: 'Phone',
        info: 'Mobile: (+88) 0255020202',
    },
    {
        title: 'Email',
        info: 'hello@cybery.ai',
    },
]
